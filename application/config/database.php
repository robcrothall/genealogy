...
|	 which can make your site vulnerable to SQL injection if you are using
|	 a multi-byte character set and are running versions lower than these.
...
|				     for the encryption, separated by
|				     colons (':')
